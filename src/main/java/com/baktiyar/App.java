...
import com.baktiyar.service.TaskService;
import com.baktiyar.splitter.StringSplitter;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (!line.equals("exit")) {
            ...
            String[] arguments = splitter.splitWithQuotes(line);
    ...
    private static void processAddArgument(String[] args) {
        Task task = new Task(String.join(" ", args[1]), Status.TODO);
    ...
    private static void processUpdateArgument(String[] args) {
        ...
        Task task = taskService.getByID(id);
        if (task != null) {
            task.setDescription(String.join(" ", args[2]));
            task.setUpdatedAt(LocalDate.now());
            taskService.update(task);
